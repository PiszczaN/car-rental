...
?>
    ...
    ?>
            ...
            <form class="action" method="post" action="list_of_denied_orders.php">
    ...
    <?php
            ...
            if($search_array[0] != "#"){
                    ...
                    inner join klienci k on(z.Klienci_idKlienci=k.idKlienci)
                    inner join samochody s on(z.Samochody_idSamochody=s.idSamochody)
                    WHERE (z.Przyjete = 0 AND z.Odrzucone = 1) AND
                ...
                if(mysqli_num_rows($t_orders) > 0){
                    ...
                    while($order = mysqli_fetch_assoc($t_orders)){
                            ...
                            echo "
                            <tr class=\"table_border\">
                                <td class=\"row\" style=\"background-color: #ff7878\">".$i." (#".$order["idZamowienia"].")</td>
                                <td class=\"row\" style=\"background-color: #ff7878\">".$order["Imie"]." (#".$order["idKlienci"].")</td>
                                ...
                                <td class=\"row\" style=\"background-color: #ff7878\">".$order["samochod"]." (#".$order["idSamochody"].")</td>
                            </tr>"; $i++;
                    }
                    echo "</table></section>";
                }else{
